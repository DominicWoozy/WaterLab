...
import { cachedReceiver } from './cached-receiver.mjs';
...
const optimizedModule = device.createShaderModule({
  code: cachedReceiver(baselineShader(features.includes('float32-filterable'))),
});
...
console.log(
  JSON.stringify(
    {
      comparison: 'cached terminal receiver intersection',
      features,
      particles: n,
