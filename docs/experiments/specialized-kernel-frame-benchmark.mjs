...
const { specializedKernels } = await import('./specialized-kernels.mjs');
const sharedControl = await specializedKernels(sim, {
  prune: process.env.PRUNE === '1',
  constants: process.env.CONSTANTS !== '0',
  ...
  JSON.stringify(
    {
      ...
      constants: process.env.CONSTANTS !== '0',
      freeze: process.env.FREEZE === '1',
      compileMs: sharedControl.compileMs,
